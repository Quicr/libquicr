...
static void BM_HexEndecEncode4x32_to_128(benchmark::State& state)
{
...
static void BM_HexEndecDecode128_to_4x32(benchmark::State& state)
{
    quicr::HexEndec<128, 32, 32, 32, 32> format;
    for (auto _ : state)
    {
...
static void BM_HexEndecEncode4x16_to_64(benchmark::State& state)
{
...
static void BM_HexEndecDecode64_to_4x16(benchmark::State& state)
{
    quicr::HexEndec<64, 16, 16, 16, 16> format;
    for (auto _ : state)
    {
...
static void BM_HexEndecRealEncode(benchmark::State& state)
{
...
static void BM_HexEndecRealDecode(benchmark::State& state)
{
    quicr::HexEndec<128,24,8,24,8,16,48> format;

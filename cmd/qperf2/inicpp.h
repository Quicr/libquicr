...
namespace ini {
    ...
    struct Convert<bool>
    {
        void decode(const std::string& value, bool& result)
        {
            ...
            std::transform(
              str.begin(), str.end(), str.begin(), [](const char c) { return static_cast<char>(::toupper(c)); });
    ...
    {
        void decode(const std::string& value, unsigned long long& result) { result = std::stoull(value); }

        void encode(const unsigned long long value, std::string& result)
        {
            std::stringstream ss;
            ss << value;
            result = ss.str();
    ...
    struct StringInsensitiveLess
    {
        ...
        {
            std::transform(
              lhs.begin(), lhs.end(), lhs.begin(), [](const char c) { return static_cast<char>(::tolower(c)); });
            std::transform(
              rhs.begin(), rhs.end(), rhs.begin(), [](const char c) { return static_cast<char>(::tolower(c)); });
            return lhs < rhs;
        }
    };
    ...
    class IniFileBase : public std::map<std::string, IniSectionBase<Comparator>, Comparator>
    {
      ...
      public:
        ...
        void setCommentPrefixes(const std::vector<std::string>& commentPrefixes) { commentPrefixes_ = commentPrefixes; }

...
class ServerDelegate
{
   ...
   */
  virtual void onPublishIntent(const QUICRContext& context_id,
   ...
   */
  virtual void onSubscribe(const QUICRContext& context_id,
...
class QuicRServer
{
   ...
   */
  QuicRServer(ITransport&, ServerDelegate& delegate) explicit;
   ...
   */ 
  void publishIntentResponse(const QUICRContext& context_id,
                             const QUICRNamespace& quicr_namespace,
   ...
   * @todo: Add payload with origin signed blob
   */
  void subscribeResponse(const QUICRContext& context_id,
                         const QUICRNamespace& quicr_namespace,
   ...
   *           reasons
   */
  void subscriptionEnded(const QUICRContext& context_id,
                         const QUICRNamespace& quicr_namespace,
                         const SubscribeResult& result);
   ...
   * 
   */
  void sendNamedObject(const QUICRContext& context_id,
    ...
    * 
   */
  void sendNamedFragment(const QUICRContext& context_id,

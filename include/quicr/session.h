...
namespace quicr {
      ...
      , public std::enable_shared_from_this<Session>
    {
      ...
      private:
        ...
        void SendFetch(std::uint64_t request_id,
                       const FullTrackName& tfn,
                       std::uint8_t priority,
                       std::optional<messages::GroupOrder> group_order,
        ...
        void SendJoiningFetch(std::uint64_t request_id,
                              std::uint8_t priority,
                              std::optional<messages::GroupOrder> group_order,
        ...
        void SendFetchOk(std::uint64_t request_id,
                         messages::GroupOrder publisher_default_group_order,
                         bool end_of_track,
      ...
      private:
        ...
        std::map<std::uint64_t, Bytes> ctrl_stream_buffers_;

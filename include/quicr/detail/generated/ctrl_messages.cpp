...
namespace quicr::messages {
     ...
     */
    TrackStatus::TrackStatus(std::function<void(TrackStatus&)> group_0_cb, std::function<void(TrackStatus&)> group_1_cb)
      : group_0_cb(group_0_cb)
      , group_1_cb(group_1_cb)
    {
        if (group_0_cb == nullptr) {
     ...
     */
    TrackStatusOk::TrackStatusOk(std::function<void(TrackStatusOk&)> group_0_cb)
      : group_0_cb(group_0_cb)
    {
        if (group_0_cb == nullptr) {
            throw std::invalid_argument("Callbacks must be specified");
     ...
     */
    Publish::Publish(std::function<void(Publish&)> group_0_cb)
      : group_0_cb(group_0_cb)
    {
        if (group_0_cb == nullptr) {
            throw std::invalid_argument("Callbacks must be specified");
     ...
     */
    PublishOk::PublishOk(std::function<void(PublishOk&)> group_0_cb, std::function<void(PublishOk&)> group_1_cb)
      : group_0_cb(group_0_cb)
      , group_1_cb(group_1_cb)
    {
        if (group_0_cb == nullptr) {

...
namespace quicr::messages {
    ...
    struct SubscribeError
    {
      ...
      public:
        ...
        // All fields constructor
        SubscribeError(RequestID request_id, SubscribeErrorErrorCode error_code, ErrorReason error_reason)
          : request_id(request_id)
    ...
    struct PublishNamespace
    {
      ...
      public:
        ...
        // All fields constructor
        PublishNamespace(RequestID request_id, TrackNamespace track_namespace, Parameters parameters)
          : request_id(request_id)
          , track_namespace(track_namespace)
          , parameters(parameters)
        {
    ...
    struct PublishNamespaceOk
    {
      ...
      public:
        ...
        // All fields constructor
        PublishNamespaceOk(RequestID request_id)
          : request_id(request_id)
        {
        }
    ...
    struct PublishNamespaceError
    {
      ...
      public:
        ...
        // All fields constructor
        PublishNamespaceError(RequestID request_id, PublishNamespaceErrorErrorCode error_code, ErrorReason error_reason)
          : request_id(request_id)
          , error_code(error_code)
          , error_reason(error_reason)
        {
    ...
    struct PublishNamespaceDone
    {
      ...
      public:
        ...
        // All fields constructor
        PublishNamespaceDone(TrackNamespace track_namespace)
          : track_namespace(track_namespace)
        {
        }
    ...
    struct PublishDone
    {
      ...
      public:
        ...
        // All fields constructor
        PublishDone(RequestID request_id,
    ...
    struct PublishNamespaceCancel
    {
      ...
      public:
        ...
        // All fields constructor
        PublishNamespaceCancel(TrackNamespace track_namespace, ErrorCode error_code, ErrorReason error_reason)
          : track_namespace(track_namespace)
          , error_code(error_code)
          , error_reason(error_reason)
        {
    ...
    struct TrackStatus
    {
      ...
      public:
        ...
        TrackStatus(std::function<void(TrackStatus&)> group_0_cb, std::function<void(TrackStatus&)> group_1_cb);
    ...
    struct TrackStatusOk
    {
      ...
      public:
        ...
        // All fields constructor
        TrackStatusOk(RequestID request_id,
                      TrackAlias track_alias,
                      Expires expires,
                      GroupOrder group_order,
                      ContentExists content_exists,
        ...
        TrackStatusOk(std::function<void(TrackStatusOk&)> group_0_cb);
    ...
    struct TrackStatusError
    {
      ...
      public:
        ...
        // All fields constructor
        TrackStatusError(RequestID request_id, TrackStatusErrorErrorCode error_code, ErrorReason error_reason)
          : request_id(request_id)
          , error_code(error_code)
          , error_reason(error_reason)
        {
    ...
    struct SubscribeNamespace
    {
      ...
      public:
        ...
        // All fields constructor
        SubscribeNamespace(RequestID request_id, TrackNamespacePrefix track_namespace_prefix, Parameters parameters)
          : request_id(request_id)
    ...
    struct SubscribeNamespaceOk
    {
      ...
      public:
        ...
        // All fields constructor
        SubscribeNamespaceOk(RequestID request_id)
          : request_id(request_id)
        {
        }
    ...
    struct SubscribeNamespaceError
    {
      ...
      public:
        ...
        // All fields constructor
        SubscribeNamespaceError(RequestID request_id,
    ...
    struct UnsubscribeNamespace
    {
      ...
      public:
        ...
        // All fields constructor
        UnsubscribeNamespace(TrackNamespacePrefix track_namespace_prefix)
          : track_namespace_prefix(track_namespace_prefix)
        {
        }
    ...
    struct Publish
    {
      ...
      public:
        ...
        Publish(std::function<void(Publish&)> group_0_cb);
    ...
    struct PublishOk
    {
      ...
      public:
        ...
        // All fields constructor
        PublishOk(RequestID request_id,
                  Forward forward,
                  SubscriberPriority subscriber_priority,
                  GroupOrder group_order,
                  FilterType filter_type,
        ...
        PublishOk(std::function<void(PublishOk&)> group_0_cb, std::function<void(PublishOk&)> group_1_cb);
    ...
    struct PublishError
    {
      ...
      public:
        ...
        // All fields constructor
        PublishError(RequestID request_id, ErrorCode error_code, ErrorReason error_reason)
          : request_id(request_id)
          , error_code(error_code)
          , error_reason(error_reason)
        {

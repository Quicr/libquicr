...
{
  CHECK_EQ(0x0_name + 0xFFFFFFFFFFFFFFFF0000000000000000_name,
           0xFFFFFFFFFFFFFFFF0000000000000000_name);
  CHECK_EQ(0x0FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF_name +
             0x0000000000000000FFFFFFFFFFFFFFFF_name,
           0x1000000000000000FFFFFFFFFFFFFFFE_name);
  CHECK_EQ(0xEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE_name +
             0x11111111111111111111111111111111_name,
           0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF_name);

  CHECK_EQ(0x0000000000000000FFFFFFFFFFFFFFFF_name -
             0x0000000000000000FFFFFFFFFFFFFFFF_name,
           0x0_name);

  CHECK_EQ(0xFFFFFFFFFFFFFFFF0000000000000000_name -
             0xFFFFFFFFFFFFFFFF0000000000000001_name,
           0xFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF_name);

  CHECK_EQ(0xFFFFFFFFFFFFFFFF0000000000000000_name -
             0xFFFFFFFFFFFFFFFE0000000000000001_name,
           0x0000000000000000FFFFFFFFFFFFFFFF_name);
}

...
TEST_CASE("QUICR::Name Basic Test ")
{
  ...
  // CHECK( quicr::Name("0x123456789abcd0123456789abcd0") >> 64 ==  quicr::Name(
  // 0x123456789abcd0 ) );
  CHECK(quicr::Name("0x123456789abcd0FFFFFFFFFFFFFF") + 1 ==
        quicr::Name("0x123456789abcd10000000000000000"));
}
